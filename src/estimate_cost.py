...
from utils import read_json, find_files, compute_usage

def estimate_cost(datapath, model="gpt-4", input_attrs=["system_prompt", "user_prompt"], output_attrs=["output"], max_input_tokens=None, max_output_tokens=None):
...
def main():
    ...
    for file_path in files_to_process:
        input_cost, output_cost = estimate_cost(file_path, model=args.model, input_attrs=args.input_attrs, output_attrs=args.output_attrs, 
