...
# pilot run 1
# python export_metrics.py -i ../experiments/reports/pilot/${report_name}/gpt-4 -o pilot2_gpt-4_${report_name}_metrics.csv
# python export_metrics.py -i ../experiments/reports/pilot/${report_name}/gemini-1.5-flash -o pilot2_gemini-1.5-flash_${report_name}_metrics.csv
# python export_metrics.py -i ../experiments/reports/pilot/${report_name}/claude-3-5-sonnet-20240620 -o pilot2_claude-3-5-sonnet-20240620_${report_name}_metrics.csv
# python export_metrics.py -i ../experiments/reports/pilot/${report_name}/llama-3.1-405b-instruct -o pilot2_llama-3.1-405b-instruct_${report_name}_metrics.csv
