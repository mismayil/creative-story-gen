...
#                         -o ../experiments/reports/pilot3/${report_name}/figures -p default -f png -t violin

python plot_metrics.py -i ../experiments/reports/pilot3/${report_name}/human/pilot3_human_${report_name}_metrics.csv \
                          ../experiments/reports/pilot3/${report_name}/machine/pilot3_machine_${report_name}_metrics.csv \
                        -o ../experiments/reports/pilot3/${report_name}/figures -p default_model_size -f png
...
#                         -o ../experiments/reports/pilot3/${report_name}/figures/global -p default n_gram_diversity raw_surprises -t bar -f png