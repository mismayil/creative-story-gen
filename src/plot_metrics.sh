...
# machine vs human
python plot_metrics.py -i ../experiments/reports/pilot2/${report_name}/human/pilot2_human_${report_name}_metrics.csv \
                          ../experiments/reports/pilot2/${report_name}/machine/pilot2_machine_${report_name}_metrics.csv \
                        -o ../experiments/reports/pilot2/${report_name}/figures -f png

python plot_metrics.py -i ../experiments/reports/pilot2/${report_name}/human/pilot2_human_${report_name}_metrics_global.csv \
                          ../experiments/reports/pilot2/${report_name}/machine/pilot2_machine_${report_name}_metrics_global.csv \
                        -o ../experiments/reports/pilot2/${report_name}/figures -p n_gram_diversity raw_surprises -f png